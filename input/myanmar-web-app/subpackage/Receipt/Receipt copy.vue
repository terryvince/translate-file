				...
				<view class="receipt-li" v-for="item in list" :key="item.id">
					...
					<view class="receipt-li-text">
						...
						<view class="receipt-li-text-fot">
							...
							<view class="receipt-li-text-fot-btn">ငွေတောင်းခံလွှာကိုကြည့်ပါ</view>
						</view>
					</view>
				</view>
			</navigator>
			<!-- တင်နေသည်/နောက်ထပ်အချက်အလက်မရှိပါ -->
	...
	export default {
		...
		data() {
			return {
				status: 'more',
				isListNull: true,
				title: 'သင့်ငွေတောင်းခံလွှာကအချည်းနှီးပါ~',
				list: [
					{
						id: 1,
						img: '../static/logo.jpg',
						title: 'ဘုန်းတော်ကြီး ( RU CC ) ရိုးရှင်း，သင်းအုပ်ဆရာ Amour Bedcloth',
						price: '23.00'
					},
					{
						id: 2,
				...
				contentText: {
					contentdown: 'ပိုပြီးတင်ရန်တက်ပါ',
					contentrefresh: 'တင်နေသည်',
					contentnomore: 'မရှိတော့ပါ'
				},
				type: "5",
				page: 1,
				limit: 20,
		...
		onPullDownRefresh() {
			console.log('စတင်ရန်ချပါ')
			this.getOrderList();
			setTimeout(function() {
				console.log('အဆုံးသတ်ပစ်ရန်')
			}, 1000);
		},
		onReachBottom() {
			console.log('စတင်ပါ')
