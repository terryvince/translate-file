...
<template>
	<view class="user-account">
				...
				<view class="headerCon">
					<view class="account acea-row row-top row-between">
						...
						<navigator url="/subpackage/userAccount/withdrawRule" class="recharge font-color-whitle">
							...
							ကူးပြောင်းခြင်းနည်းဥပဒေများ
						</navigator>
					</view>
				</view>
			</view>
			<view class="nav">
				<view class="acea-row row-middle row-center title">ဟန်ချက်ညီရန်အချက်များပြောင်းလဲ</view>
				<view class="acea-row row-middle uni-form-item uni-column input-row">
					<input class="uni-input input" v-model="inputValue" type="number" @input="onKeyInput" placeholder="¥ ကျေးဇူးပြု၍ ပြောင်းလဲခြင်းအမှတ်များကိုထည့်ပါ" />
		...
		<view class="desrc">
			<view class="">
				1.စီမံခန့်ခွဲသူမှပေးသောပြောင်းလဲမှုအချိုးအရအမှတ်များသည်ဟန်ချက်ညီရန်ပြောင်းလဲသည်
			</view>
			<view class="">
				2.Point Balance လျှောက်လွှာတင်ပြီးသည်နှင့်ချက်ချင်းထိရောက်ပါသည်
			</view>
		</view>
...
<script>
	...
	var sucess = {
		image: sucessImg,
		title: "အောင်မြင်သောပြောင်းလဲခြင်း",
		message: "ပြောင်းလဲခြင်းလျှောက်လွှာတွင်ပါလိမ့်မည်7ရက်အတွင်း,အထွတ်အထိပ်၏အမှု၌,နှောင့်နှေးနိုင်ပါသည်,စိတ်ရှည်ရှည်နဲ့စောင့်ပါ.",
		action: "ပြန်သွားအမှတ်"
	}
	var failed = {
		image: failImg,
