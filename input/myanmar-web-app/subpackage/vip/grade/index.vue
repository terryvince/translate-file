	...
	<view class="space-wrap">
		...
		<view class="vip-grade top-73">
			...
			<view class="tips fs-28 color-tip lh-2_ z-index-2">
				<!-- <view class="vip-tip">မင်္ဂလာရှိသောလစဉ်မဲနှိုက်ခြင်း <text class="color-danger txt-bold" :decode="true">&nbsp;&nbsp;2&nbsp;&nbsp;</text> Times，</view>
				<view class="vip-tip">လတိုင်း Treasure Hunting တွင်ပါ ၀ င်ပါ <text class="color-danger txt-bold" :decode="true">&nbsp;1&nbsp;</text> Times，</view>
				<view class="vip-tip">ပြည်တွင်းရေးဆုတွင်ပါ ၀ င်ပါကလေးပုံတစ်ပုံတိုင်းဆွဲသည်<text class="color-danger txt-bold" :decode="true">&nbsp;&nbsp;1&nbsp;&nbsp;</text> Times，</view>
				<view class="vip-tip">နှစ်ပတ်လည်ခရီးသွားဆုများ၌ပါ ၀ င်ပါ <text class="color-danger txt-bold" :decode="true">&nbsp;&nbsp;1&nbsp;&nbsp;</text> Times。</view> -->
				<view class="width-full" v-html="cardList[current].detail"></view>
			</view>
		</view>
		<!-- အခွင့်အရေးများကိုအဆင့်မြှင့်တင် -->
		<view v-if="cardList[current+1]" class="vip-grade top-106">
			...
			<view class="tips fs-28 color-tip lh-2_ z-index-2">
				<view class="vip-tip">
					<text>နောက်အဆင့်</text>
					<text class="fs-32 txt-bold" style="margin-left: 30rpx;">L{{cardList[current].id+1}}</text>
				</view>
				<!-- <view class="vip-tip">မင်္ဂလာရှိသောလစဉ်မဲနှိုက်ခြင်း <text class="color-danger txt-bold" :decode="true">&nbsp;&nbsp;2&nbsp;&nbsp;</text> Times，</view>
				<view class="vip-tip">လတိုင်း Treasure Hunting တွင်ပါ ၀ င်ပါ <text class="color-danger txt-bold" :decode="true">&nbsp;&nbsp;2&nbsp;&nbsp;</text> Times，</view>
				<view class="vip-tip">ပြည်တွင်းရေးဆုတွင်ပါ ၀ င်ပါကလေးပုံတစ်ပုံတိုင်းဆွဲသည်<text class="color-danger txt-bold" :decode="true">&nbsp;&nbsp;1&nbsp;&nbsp;</text> Times，</view>
				<view class="vip-tip">နှစ်ပတ်လည်ခရီးသွားဆုများ၌ပါ ၀ င်ပါ <text class="color-danger txt-bold" :decode="true">&nbsp;&nbsp;1&nbsp;&nbsp;</text> Times。</view> -->
		...
		<view class="fix-bottom">
			<view @click="buyVip()" class="post-btn bg-danger">အသင်း ၀ င်မှုအဆင့်ကိုဝယ်ပါ</view>
		</view>
	</view>
</template>
