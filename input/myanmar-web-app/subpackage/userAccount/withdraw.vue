...
<template>
	<view class="user-account">
		<view class="wrapper">
			...
			<view class="nav">
				<view class="acea-row row-middle row-center title">WeChat ပိုက်ဆံအိတ်သို့ငွေထုတ်ယူပါ</view>
				<view class="acea-row row-middle uni-form-item uni-column input-row">
					<input class="uni-input input" v-model="post.money" type="number" @input="onKeyInput" placeholder="¥ ငွေထုတ်ယူပါ" />
		...
		<view class="desrc">
			<view class="">
				1.သင်သည်လက်ရှိခွင့်ပြုထားသော WeChat အကောင့်ကိုပြန်လည်ရုပ်သိမ်းပါမည်
			</view>
			<view class="">
				2.ထုတ်ယူခြင်းလျှောက်လွှာတွင်ပါလိမ့်မည်7ရက်အတွင်း,အထွတ်အထိပ်၏အမှု၌,နှောင့်နှေးနိုင်ပါသည်,စိတ်ရှည်ရှည်နဲ့စောင့်ပါ.
			</view>
		</view>
...
<script>
	...
	var sucess = {
		...
		message: "ထုတ်ယူခြင်းလျှောက်လွှာတွင်ပါလိမ့်မည်7ရက်အတွင်း，အထွတ်အထိပ်၏အမှု၌，နှောင့်နှေးနိုင်ပါသည်，စိတ်ရှည်ရှည်နဲ့စောင့်ပါ.",
		action: "ပြန်အမ်းငွေ"
	}
	var failed = {
		image: failImg,
		title: "တင်သွင်းမှုမအောင်မြင်ပါ",
		message: "သင့်တွင်မေးခွန်းများရှိပါက ကျေးဇူးပြု၍ ဖောက်သည်ဝန်ဆောင်မှုဌာနသို့ဆက်သွယ်ပါ！",
		action: "ပြန်အမ်းငွေ"
	}
		...
		methods: {
			...
			async continueAction() {
				...
				if (parseFloat(money) <= 0) {
					uni.showToast({
						title: 'ကျေးဇူးပြု၍ ပြန်လည်ထုတ်ယူမည့်ငွေပမာဏကိုထည့်ပါ',
						icon: 'none',
						duration: 2000
					});
					return;
