...
<template>
	<view class="aboutUs" :style="{height: boxHeight}">
		...
		<view class="content-box" id="content">
			...
			<view class="badge-margin badge badge-mini badge-defalut">စီးပွားရေးလုပ်ငန်း</view>
			...
			<view class="flex-main-start top-30">
				...
				<text class="fs-24 color-text txt-bold">ကုမ္ပဏီအကြောင်း</text>
			</view>
			...
			<view class="flex-main-start">
				<image src="../static/au-tip.png" class="size-31"></image>
				<text class="fs-24 color-text txt-bold">စီးပွားရေးဓာတ်ပုံ</text>
			</view>
