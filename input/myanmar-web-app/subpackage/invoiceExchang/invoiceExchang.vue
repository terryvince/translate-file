	...
	<view class="excha">
		<view class="excha-list">
			<view class="excha-list-li">
				<view class="excha-list-title">အမှာစာနံပါတ်</view>
			...
			<view class="excha-list-li">
				<view class="excha-list-title">ငွေတောင်းခံလွှာအမျိုးအစား</view>
				<view class="excha-list-rig">
					<view class="excha-list-rig-text">အီလက်ထရောနစ်အထွေထွေငွေတောင်းခံလွှာ</view>
					<view class="excha-list-rig-img"><text v-if='isShowJt' class="iconfont icon-jiantou"></text></view>
				</view>
			</view>
			<view class="excha-list-li">
				<view class="excha-list-title">ငွေတောင်းခံလွှာအကြောင်းအရာ</view>
			...
			<view class="excha-list-li">
				<view class="excha-list-title">ငွေတောင်းခံလွှာ</view>
		...
		<view class="excha-list" v-if="form.type == 1">
			<view class="excha-list-li">
				<view class="excha-list-title">ယူနစ်အမည်</view>
				<view class="excha-list-rig">
					<view class="excha-list-rig-text"><input type="text" v-model="form.receiptName" placeholder="လိုအပ်သည်" /></view>
				</view>
			</view>
			<view class="excha-list-li">
				<view class="excha-list-title">အခွန်ကုဒ်နံပါတ်</view>
				<view class="excha-list-rig">
					<view class="excha-list-rig-text"><input type="text" v-model="form.receiptCode" placeholder="လိုအပ်သည်" /></view>
				</view>
			</view>
		</view>
		<view class="excha-list">
			<view class="excha-list-li">
				<view class="excha-list-title">ဖုန်း</view>
				<view class="excha-list-rig">
					<view class="excha-list-rig-text"><input type="text" v-model="form.phone" placeholder="လိုအပ်သည်" /></view>
				</view>
			</view>
			<view class="excha-list-li">
				<view class="excha-list-title">စာတိုက်ပုံး</view>
				<view class="excha-list-rig">
					<view class="excha-list-rig-text"><input type="text" v-model="form.email" placeholder="optional ကို" /></view>
				</view>
			</view>
		</view>
		<view class="excha-btn" @click="continueAction">တင်သွင်း</view>
	...
	export default {
		...
		data() {
			return {
				...
				contNum: 0,
				contName: 'ကုန်ပစ္စည်းအသေးစိတ်',
				dwName: "ပုဂ္ဂိုလ်ရေး",
				contArr: [{
						id: 1,
						name: 'ကုန်ပစ္စည်းအသေးစိတ်'
					},
					{
						id: 2,
						name: 'ကုန်ပစ္စည်းအမျိုးအစား'
					}
				],
				form: {
					email: "",
		...
		methods: {
			continueAction() {
				if (!this.form.phone) {
					uni.showToast({
						title: 'ကျေးဇူးပြု၍ သင့်ဖုန်းနံပါတ်ကိုဖြည့်ပါ',
						icon: 'none',
						duration: 2000
					});
					return;
				...
				if (this.form.type == 1) {
					if (!this.form.receiptCode) {
						uni.showToast({
							title: 'ကျေးဇူးပြုပြီးအခွန်နံပါတ်ဖြည့်ပါ',
							icon: 'none',
							duration: 2000
						});
						return;
					...
					if (!this.form.receiptName) {
						uni.showToast({
							title: 'ကျေးဇူးပြုပြီးယူနစ်နာမည်ဖြည့်ပါ',
							icon: 'none',
							duration: 2000
						});
						return;
