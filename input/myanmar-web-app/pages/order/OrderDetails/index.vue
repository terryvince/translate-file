...
<template>
	<view class="order-details">
		...
		<!-- orderInfo.useIntegral>0 ရမှတ်များကိုပေးချေရန်အသုံးပြုသည် -->
		...
		<view class="wrapper">
			<view class="item acea-row row-between">
				...
				<view class="conter">
					...
					<text>{{ orderInfo.totalPrice }}{{orderInfo.useIntegral>0 ? 'အရေးပါသော':''}}</text>
				</view>
			</view>
			...
			<view class="item acea-row row-between" v-if="orderInfo.useIntegral > 0">
				...
				<view class="conter">
					-<text v-if="!orderInfo.useIntegral">￥</text>
					<text>{{ orderInfo.deductionPrice }}{{orderInfo.useIntegral>0 ? 'အရေးပါသော':''}}</text>
				</view>
			</view>
		...
		<view class="footer acea-row row-right row-middle" v-if="!refundOrder && offlineStatus">
			...
			<template v-if="status.type == 0">
				...
				<view class="bnt bg-color-green" @click="pay = true">ချက်ချင်းငွေပေးချေခြင်း</view>
			</template>
        ...
        <view class="bnt cancel" @click="goGoodsReturn(orderInfo)">ပြန်အမ်းငွေတောင်းခံပါ</view>
			...
			<template v-if="status.type == 2">
				...
				<view class="bnt bg-color-green" @click="takeOrder">လက်ခံရရှိကိုအတည်ပြုပါ</view>
			</template>
        ...
        ">ထောက်ပံ့ပို့ဆောင်ရေးကိုကြည့်ပါ</view>
			...
			<template v-if="status.type == 6">
				<view class="bnt bg-color-green" @click="goGroupRule(orderInfo)">Join Group ကိုကြည့်ပါ</view>
			</template>
		</view>
