<template>
  <view class="bill-details" ref="container">
    <view class="nav acea-row">
      <view class="item" :class="types == 0 ? 'on' : ''" @click="changeTypes(0)">အားလုံး</view>
      <view class="item" :class="types == 1 ? 'on' : ''" @click="changeTypes(1)">စားသုံးမှု</view>
      <view class="item" :class="types == 2 ? 'on' : ''" @click="changeTypes(2)">အားသွင်းပါ</view>
    </view>
