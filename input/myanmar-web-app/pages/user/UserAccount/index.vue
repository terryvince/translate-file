		...
		<view class="wrapper">
			<view class="header">
				<view class="headerCon">
					<view class="account acea-row row-top row-between">
						...
						<navigator url="/pages/user/Recharge/index" class="recharge font-color-red">ထုတ်ယူစည်းမျဉ်းများ</navigator>
					</view>
				</view>
			</view>
			<view class="nav acea-row row-middle">
				...
				<view class="item" @click="goUserBill(1)">
					<view>အောင်မြင်သောဆုတ်ခွာ</view>
				</view>
				<view class="item" @click="goUserBill(2)">
					<view>ထုတ်ယူမှုမအောင်မြင်ပါ</view>
				</view>
			</view>
