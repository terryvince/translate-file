      ...
      <view class="header">
        <view class="headerCon">
          <view class="account acea-row row-top row-between">
            <view class="assets">
              <view>စုစုပေါင်းပိုင်ဆိုင်မှုများ(ယွမ်)</view>
              <view class="money">{{ now_money }}</view>
            </view>
            <!-- <navigator url="/pages/user/Recharge/index" class="recharge font-color-red">အားသွင်းပါ</navigator> -->
          </view>
          <view class="cumulative acea-row row-top">
            <view class="item">
              <view>တိုးပွားလာသောစားသုံးမှု(ယွမ်)</view>
