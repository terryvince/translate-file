					...
					<view class="list" v-for="(shopItem, shopIndex) in cartList.valid" :key="shopIndex">
						<view class="shopClass">
							<view class="item acea-row row-between-wrapper" style="height: 30rpx;">
								...
								<text style="font-size: 28rpx;">စုစုပေါင်း{{shopItem.storeCartQueryVoList.length}}ပစ္စည်းများ</text>
							</view>
				...
				<view class="invalidGoods" v-if="cartList.invalid.length > 0">
					<view class="goodsNav acea-row row-between-wrapper">
						<view @click="goodsOpen">
							<text class="iconfont" :class="invalidGoodsHidden === true ? 'icon-xiangyou' : 'icon-xiangxia'"></text>ကုန်ဆုံးကုန်ပစ္စည်းများ
						</view>
	...
	export default {
		...
		data: function() {
			return {
				...
				validList: [],
				isAllSelect: false, //စျေးဝယ်ခြင်းတောင်းအားလုံးကိုရွေးချယ်ပါ
				isAllSelectByShop: false, //ကုန်သည်များအားလုံးကိုရွေးချယ်ပါ
				cartCount: 0, //unused
				count: 0, //စျေးဝယ်လှည်းအရေအတွက်
				invalidCount: 0, //အမှာစာအရေအတွက်
				countmoney: 0,
		...
		methods: {
			...
			//စျေးဝယ်ခြင်းတောင်းစာရင်းကိုရယူပါ
			...
			//ကုန်သည်၏စျေး ၀ ယ်လှည်းအရေအတွက်ကိုတွက်ချက်ပါ
			...
			//ရွေးချယ်ထားသောထုတ်ကုန်များကိုဖျက်ပါ；
			delgoods: function() {
				let that = this,
					id = [],
					valid = [],
			...
			collectAll: function() {
				...
				async function control(arr,limit){   // တစ်ပြိုင်နက်တည်းထိန်းချုပ်မှု
					if(arr.length==0){
						return 'ok'
					}
