...
export default {
  ...
  methods: {
    titleInfo: function() {
      ...
      if (type === "1") {
        this.name = "အကြံပြုပါသည်";
        this.icon = "icon-jingpintuijian";
        // document.title = "အကြံပြုပါသည်";
      } else if (type === "2") {
        this.name = "လူကြိုက်များစာရင်း";
        this.icon = "icon-remen";
        // document.title = "လူကြိုက်များစာရင်း";
      } else if (type === "3") {
        this.name = "ထုတ်ကုန်အသစ်";
        this.icon = "icon-xinpin";
        // document.title = "ထုတ်ကုန်အသစ်";
      }
    },
