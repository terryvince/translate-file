		...
		<view class="searchGood">
			<view class="search acea-row row-between-wrapper">
				<view class="input acea-row row-between-wrapper">
					...
					<input type="text" placeholder="ထုတ်ကုန်များကိုရှာဖွေရန်ကိုနှိပ်ပါ" v-model="search" />
				</view>
				<view class="bnt" @click="submit">အားရှာဖွေခြင်း</view>
			</view>
			<view v-if="history.length">
				<view class="acea-row row-between-wrapper">
					<view class="title">ရှာဖွေမှုသမိုင်း</view>
					<view class="title clear" @click="clear">ရှာဖွေခြင်းရာဇဝင်ကိုရှင်းပါ</view>
				</view>
			...
			<view v-if="keywords.length">
				<view class="title">လူကြိုက်များသောရှာဖွေမှုများ</view>
				<view class="list acea-row">
...
<script>
	...
	export default {
		...
		methods: {
			...
			// အချည်းနှီးသော string ကိုခွင့်ပြုပါ
			toSearch(s) {
				// console.log(s)
				// if (!s) return;
				//ဒေသခံ cache ကို
