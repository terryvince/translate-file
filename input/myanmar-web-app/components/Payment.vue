  ...
  <view>
    <view class="payment" :class="value === true ? 'on' : ''">
      <view class="title acea-row row-center-wrapper">
        ငွေသားဖြင့်ပေးချေရန်ရွေးချယ်ပါ<text class="iconfont icon-guanbi" @click="close"></text>
      </view>
      <view
      ...
      >
        <view class="left acea-row row-between-wrapper">
          ...
          <view class="text">
            <view class="name">WeChat Pay</view>
            <view class="info">WeChat ကို သုံး၍ အမြန်ငွေပေးချေမှု</view>
          </view>
        </view>
      ...
      >
        <view class="left acea-row row-between-wrapper">
          ...
          <view class="text">
            <view class="name">AliPay ကပေးဆောင်</view>
            <view class="info">အွန်လိုင်း Alipay ဖြင့်ငွေပေးချေပါ</view>
          </view>
        </view>
        <view class="iconfont icon-xiangyou"></view>
      </view> -->
      ...
      >
        <view class="left acea-row row-between-wrapper">
          ...
          <view class="text">
            <view class="name">ငွေလက်ကျန်</view>
            <view class="info">
              လက်ရှိရရှိနိုင်သောလက်ကျန်ငွေ：<text class="money">{{ balance }}</text>
            </view>
          </view>
        </view>
        <view class="iconfont icon-xiangyou"></view>
      ...
      >
        <view class="left acea-row row-between-wrapper">
          ...
          <view class="text">
            <view class="name">အော့ဖ်လိုင်းငွေပေးချေမှု</view>
            <view class="info">အော့ဖ်လိုင်းငွေပေးချေမှုနည်းလမ်းကိုရွေးချယ်ပါ</view>
          </view>
        </view>
        <view class="iconfont icon-xiangyou"></view>
      </view> -->
