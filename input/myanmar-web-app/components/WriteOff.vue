<template>
  <view v-show="iShidden === false">
    <view class="WriteOff">
      ...
      <view class="tip">ဒီအမိန့်ကိုသင်ဖျက်သိမ်းချင်လားသေချာလား？</view>
      <view class="sure" @click="confirm">write-off အတည်ပြုပါ</view>
      <view class="sure cancel" @click="cancel">ပယ်ဖျက်</view>
    </view>
