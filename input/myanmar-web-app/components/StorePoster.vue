  ...
  <view v-if="posterImageStatus" class="poster-first">
    ...
    <!-- <view class="poster-pop" v-show="!canvasStatus">
      ...
      <view class="canvas" ref="poster">
        <image class="image" :src="posterData.image" alt="ထုတ်ကုန်ပုံ" />
        ...
        <view class="code">
          <view class="code-img">
            <image :src="posterData.code" show-menu-by-longpress mode="widthFix" alt="QR ကုဒ်" />
          </view>
          <view class="code-text">
            <text>QR ကုဒ်ကိုခွဲခြားသတ်မှတ်ရန်ကြာမြင့်စွာနှိပ်ပါ အခုဝယ်ပါ</text>
          </view>
        </view>
      </view>
      <view class="save-poster" @click="savePosterPath">ရုပ်ပုံထုတ်လုပ်ရန်</view>
    </view>-->
    <view class="poster-pop" v-show="canvasStatus">
      <img
        src="@/static/images/poster-close.png"
      ...
      <image
        ...
        mode="widthFix"
      />
      <view class="keep">ဖုန်းကိုသိမ်းရန်ပုံကိုကြာမြင့်စွာနှိပ်ပါ</view>
    </view>
...
export default {
  ...
  methods: {
    ...
    savePosterPath: function() {
      ...
      uni.showLoading({ title: "ပိုစတာမျိုးဆက်", mask: true });
      ...
      // return;
      // //အသစ်တဖန်မွေးဖွားရန်ပုံကိုရှင်းပစ်ပါ
      // that.posterImage = "";
      // uni.showLoading({ title: "ပိုစတာမျိုးဆက်", mask: true });
      // console.log(this);
