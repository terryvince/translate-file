...
<script>
	...
	/**
	 * LoadMore ပိုပြီး load
	 * @description စာရင်းထဲတွင်အသုံးပြုခဲ့သည်，လှိမ့်တင်ခြင်းအတွက်အသုံးပြုပါ，ကြွားသည် loading အမျိုးမျိုးသောပြည်နယ်များ
	 * @tutorial https://ext.dcloud.net.cn/plugin?id=29
	 * @property {String} status = [more|loading|noMore] loading status
	 * 	@value more loadingအရင်က
	 * 	@value loading loadingin
	 * 	@value noMore မရှိတော့ပါ
	 * @property {Number} iconSize ပုံအရွယ်အစားကိုသတ်မှတ်ပါ
	 * @property {Boolean} iconSize = [true|false] ပြသဖို့လား loading အိုင်ကွန်
	 * @property {String} iconType = [snow|circle|auto] အိုင်ကွန်စတိုင်ကိုသတ်မှတ်ပါ
	 * 	@value snow iosနှင်းဖုံးပုံစံ
	 * 	@value circle Android နိုးထလာတဲ့ပုံစံ
	 * 	@value auto ပလက်ဖောင်းပေါ်မူတည်ပြီးတင်ပုံစံကိုအလိုအလျောက်ရွေးချယ်ပါ
	 * @property {String} color အိုင်ကွန်နှင့်စာသားအရောင်
	 * @property {Object} contentText တစ်ခုချင်းစီကို status ကို၏ဖော်ပြချက်，တန်ဖိုးသည်：{contentdown: "ပိုမိုပြသရန်တက်ပါ",contentrefresh: "တင်...",contentnomore: "နောက်ထပ်အချက်အလက်မရှိပါ"}
	 * @event {Function} clickLoadMore ပိုပြီးကလစ်နှိပ်ပါသည့်အခါဖြစ်ပေါ်သည်
	 */
	export default {
		name: 'UniLoadMore',
		props: {
			status: {
				// Pull-up အခြေအနေ：more-loadingအရင်က；loading-loadingin；noMore-မရှိတော့ပါ
				type: String,
				default: 'loading'
			},
			showIcon: {
			...
			contentText: {
				...
				default () {
					return {
						contentdown: 'ပိုမိုပြသရန်တက်ပါ',
						contentrefresh: 'တင်...',
						contentnomore: 'နောက်ထပ်အချက်အလက်မရှိပါ'
					}
				}
			}
		},
