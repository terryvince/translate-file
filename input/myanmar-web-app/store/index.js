...
const vuexStore = new Vuex.Store({
	state: {
		// ခွင့်ပြုချက်စာမျက်နှာပေါ်မှာရှိပြီးသားလား
		isAuthorizationPage: false,
		// ခွင့်ပြုထားသည်
		isAuthorization: false,
		// ဒီကနေယူရန်အကြံပြုသည်မဟုတ် token，သို့သော်၎င်းကိုပယ်ဖျက်ခြင်းသည်အခြားစာမျက်နှာများကိုထိခိုက်လိမ့်မည်
	...
	mutations: {
		...
		logout(state) {
			console.log('ရှင်းရှင်းလင်းလင်းဒေတာ')
			state.token = null;
			state.userInfo = null
		...
		userInfo({ state, commit }, force) {
			if (state.userInfo !== null && !force) {
				...
				return new Promise(reslove => {
					...
					dialog.error("အချက်အလက်ရရှိရန်မအောင်မြင်ပါ!");
				});
			}
		},
